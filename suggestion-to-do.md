...
- [x] **1.1.1. Tinh chỉnh Hero Section & CTA**
...
- [x] **1.1.2. Thêm Section cốt lõi "Why CHD? / Triết lý Du lịch Bản địa"**
...
- [x] **1.1.3. Thêm Section "Traveler Stories / Testimonials (Social Proof)"**
  - Hiển thị 3–6 cảm nhận thực tế từ du khách quốc tế/nội địa (tên, quốc gia, độ dài chuyến đi, rating 5 sao, ảnh chụp thật).
- [x] **1.1.4. Đổi phân loại sản phẩm: `Day Tours` & `Multi-Day Tours`**
...
- [x] **1.2.1. Bổ sung bảng tóm tắt "Trip Facts" ở đầu trang chi tiết Tour**
...
- [x] **1.2.2. Bổ sung mục "Good to know" (Thông tin cần biết cho du khách)**
...
- [x] **1.2.3. Tính năng "Plan this trip" → Pre-filled Contact Form**
...
- [x] **1.3.1. Viết lại câu chuyện thương hiệu About Us (Tạo dựng niềm tin)**
...
- [x] **1.4.1. Đưa toàn bộ Hard-coded Strings vào i18n Dictionary**
...
- [x] **1.4.2. Kiểm thử toàn diện Mobile-first (Mobile QA)**
...
- [x] **2.1.1. Tái cấu trúc chuyên mục Journal theo phong cách Editorial**
...
- [x] **2.2.1. Giới thiệu trải nghiệm độc đáo trước danh sách Tour**
...
- [x] **2.4.1. Thiết kế lại Footer dạng High-conversion**
