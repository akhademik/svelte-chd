...
## Corpus Check
- 183 files · ~87,296 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 687 nodes · 1003 edges · 86 communities (25 shown, 32 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d0b35fc`
...
Cohesion: 0.11
Nodes (24): DEFAULT_EXCHANGE_RATES, cachedFetch(), ExchangeRatesData, EXTRACT_BLOG_FIELDS, EXTRACT_TOUR_FIELDS, fetchAllBlogs(), fetchFeaturedBlogs(), fetchLatestExchangeRates() (+16 more)
...
### Community 37 - "tour.type.ts"
Cohesion: 0.13
Nodes (19): blog_modal, BlogModalState, tour_modal, TourModalState, GeneralKeyString, Highlights, Img_Cover, Locale_Array (+11 more)
...
Cohesion: 0.10
Nodes (3): { locale, LL, setLocale }, Testimonial, ./$types
...
## Knowledge Gaps
- **233 isolated node(s):** `COLOR_PALETTE`, `BlockRenderProps`, `name`, `private`, `version` (+228 more)
