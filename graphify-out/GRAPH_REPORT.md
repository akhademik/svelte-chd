...
## Corpus Check
- 247 files · ~121,459 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 841 nodes · 1391 edges · 94 communities (31 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b72120f5`
...
Cohesion: 0.20
Nodes (15): EN_MONTHS, filter_localized_items(), format_pax_no(), format_price(), format_price_object(), format_review_date(), FR_MONTHS, get_avatar_initials() (+7 more)

### Community 13 - "fr/index.ts"
Cohesion: 0.11
Nodes (13): about_page, blog_page, contact_page, error_page, faq_page, footer, home_page, fr (+5 more)

### Community 14 - "exchange.service.ts"
Cohesion: 0.15
Nodes (10): DEFAULT_EXCHANGE_RATES, withKvSnapshot(), cachedFetch(), memoryCache, EXCHANGE_RATES_QUERY, ExchangeRatesData, ExchangeService, defaultRates (+2 more)
...
Cohesion: 0.21
Nodes (12): matchesBlogSlug(), matchesTourSlug(), slugify(), builder, collect_gallery_images(), CollectGalleryImagesParams, config, get_blog_slug() (+4 more)
...
Cohesion: 0.23
Nodes (10): sanityClient, sanityConfig, mapSanityToTour(), mapSanityToTours(), EXTRACT_TOUR_FIELDS, getSingleTourQuery(), TOURS_BY_DAY_QUERY, TOURS_BY_HIGHLAND_QUERY (+2 more)
...
### Community 90 - "resolve_canonical_category"
Cohesion: 0.53
...
- **Why does `Logger` connect `[lang]/+page.server.ts` to `hero-image.service.ts`, `tour.service.ts`, `exchange.service.ts`, `blog.service.ts`, `resolve_canonical_category`?**
