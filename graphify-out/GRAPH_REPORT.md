...
## Corpus Check
- 188 files · ~88,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 703 nodes · 1060 edges · 84 communities (22 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c709bc5`
...
Cohesion: 0.10
Nodes (33): cachedFetch(), ExchangeRatesData, fetchAllBlogs(), fetchFeaturedBlogs(), fetchLatestExchangeRates(), fetchSingleTourBySlug(), fetchToursByType(), memoryCache (+25 more)
...
### Community 18 - "tour-details.svelte"
Cohesion: 0.29
...
## Knowledge Gaps
- **231 isolated node(s):** `COLOR_PALETTE`, `BlockRenderProps`, `name`, `private`, `version` (+226 more)
