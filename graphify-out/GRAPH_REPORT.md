...
## Corpus Check
- 248 files · ~121,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 842 nodes · 1392 edges · 93 communities (29 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ee1782c`
...
Cohesion: 0.08
Nodes (38): App, Locals, Platform, handle(), initFormatters(), extract_url(), get_lang_cookie(), get_path_name_without_base() (+30 more)
...
Cohesion: 0.06
Nodes (46): calculateHeroSlotIndex(), getHeroRotationInterval(), getNextHeroRotationDelay(), HERO_ROTATION_DEV_MS, HERO_ROTATION_PROD_MS, currentHero, currentIndex, effectiveImages (+38 more)
...
Cohesion: 0.25
Nodes (13): EN_MONTHS, filter_localized_items(), format_pax_no(), format_price(), format_price_object(), format_review_date(), FR_MONTHS, get_avatar_initials() (+5 more)
...
Cohesion: 0.15
Nodes (5): #each(), is_locale_transitioning, nav_animate_hidden, nav_deg, nav_mobile
...
Cohesion: 0.13
Nodes (3): index(), opacity, ./$types

### Community 47 - "sanity.ts"
Cohesion: 0.20
Nodes (15): DEFAULT_EXCHANGE_RATES, matchesBlogSlug(), matchesTourSlug(), defaultRates, exchange_rates_store, ExchangeRates, slugify(), builder (+7 more)
...
Cohesion: 0.20
Nodes (12): sanityClient, sanityConfig, mapSanityToTour(), mapSanityToTours(), EXTRACT_TOUR_FIELDS, getSingleTourQuery(), TOURS_BY_DAY_QUERY, TOURS_BY_HIGHLAND_QUERY (+4 more)
...
### Community 89 - "home-page.svelte"
Cohesion: 0.20
Nodes (3): booking_modal, BookingModalState, ./$types

### Community 90 - "nav-bar-logic.ts"
Cohesion: 0.26
Nodes (9): get_menu_url(), is_menu_active(), menu_items, MenuItem, MenuLink, TourService, resolve_canonical_category(), load() (+1 more)

### Community 92 - "tour.type.ts"
Cohesion: 0.15
...
- **Why does `Logger` connect `[lang]/+page.server.ts` to `blog.service.ts`, `nav-bar-logic.ts`, `tour.service.ts`?**
