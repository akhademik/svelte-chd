...
## Corpus Check
- 287 files · ~124,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 898 nodes · 1543 edges · 87 communities (24 shown, 31 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65815639`
...
Cohesion: 0.07
Nodes (42): App, Locals, Platform, handle(), initFormatters(), extractUrl(), getLangCookie(), getPathNameWithoutBase() (+34 more)
...
Cohesion: 0.10
Nodes (8): seoDescription, seoKeywords, seoOgImage, seoTitle, ./$types, ./$types, ./$types, ./$types
...
Cohesion: 0.05
Nodes (49): calculateHeroSlotIndex(), getHeroRotationInterval(), getNextHeroRotationDelay(), HERO_ROTATION_DEV_MS, HERO_ROTATION_PROD_MS, currentHero, currentIndex, effectiveImages (+41 more)
...
Cohesion: 0.15
Nodes (3): index(), SITE_CONFIG, ./$types
...
### Community 41 - "sanity.ts"
Cohesion: 0.18
Nodes (5): if(), bgImageUrl, builder, config, urlFor()
...
### Community 77 - "tour.type.ts"
Cohesion: 0.05
Nodes (51): mapSanityToTour(), mapSanityToTours(), SanityTourRaw, EXTRACT_TOUR_FIELDS, getSingleTourQuery(), TOURS_BY_DAY_QUERY, TOURS_BY_HIGHLAND_QUERY, matchesBlogSlug() (+43 more)
...
Cohesion: 0.10
Nodes (11): Translation, #each(), getMenuUrl(), isMenuActive(), MenuItem, menuItems, MenuLink, isLocaleTransitioning (+3 more)
...
Cohesion: 0.09
Nodes (25): DEFAULT_EXCHANGE_RATES, withKvSnapshot(), cachedFetch(), memoryCache, sanityClient, sanityConfig, mapSanityToBlogPost(), mapSanityToBlogPosts() (+17 more)
...
- **Why does `Logger` connect `[lang]/+page.server.ts` to `blog.service.ts`, `tour.type.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Locales` connect `i18n-types.ts` to `tour.type.ts`, `nav-bar-logic.ts`, `i18n-svelte.ts`?**
