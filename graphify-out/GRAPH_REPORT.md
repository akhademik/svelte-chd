...
## Corpus Check
- 290 files · ~125,292 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 905 nodes · 1563 edges · 89 communities (28 shown, 30 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e9f5e8e`
...
Cohesion: 0.06
Nodes (45): App, Locals, Platform, handle(), en, initFormatters(), fr, extractUrl() (+37 more)
...
Cohesion: 0.22
Nodes (6): index(), collectGalleryImages(), CollectGalleryImagesParams, deduplicateGalleryImages(), extractPortableTextImages(), SanityImageAsset
...
Cohesion: 0.07
Nodes (34): ClientConfirmationData, getAdminNotifyEmail(), getFromEmail(), sendClientConfirmation(), sendMail(), SendMailOptions, EmailTemplateProps, generateClientEmailHtml() (+26 more)
...
### Community 20 - "tour-card.svelte"
Cohesion: 0.19
Nodes (3): bookingModal, BookingModalState, ./$types
...
Cohesion: 0.16
Nodes (13): mapSanityToBlogPost(), mapSanityToBlogPosts(), SanityBlogPostRaw, ALL_BLOGS_QUERY, EXCHANGE_RATES_QUERY, EXTRACT_BLOG_FIELDS, FALLBACK_BLOGS_QUERY, FEATURED_BLOGS_QUERY (+5 more)
...
### Community 77 - "hero-image.service.ts"
Cohesion: 0.06
Nodes (38): DEFAULT_EXCHANGE_RATES, calculateHeroSlotIndex(), getHeroRotationInterval(), getNextHeroRotationDelay(), HERO_ROTATION_DEV_MS, HERO_ROTATION_PROD_MS, if(), bgImageUrl (+30 more)

### Community 78 - "portable-text-components.ts"
Cohesion: 0.12
Nodes (4): portableTextComponents, builder, config, ./$types
...
Cohesion: 0.08
Nodes (37): #each(), getMenuUrl(), isMenuActive(), MenuItem, menuItems, MenuLink, sanityClient, sanityConfig (+29 more)
...
- **Why does `Logger` connect `[lang]/+page.server.ts` to `tour.service.ts`, `i18n-types.ts`, `hero-image.service.ts`, `blog.service.ts`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Locales` connect `i18n-types.ts` to `tour.service.ts`, `i18n-svelte.ts`, `hero-image.service.ts`?**
