...
<p
	...
	class="font-figtree flex flex-col bg-clip-text bg-center bg-no-repeat text-center text-[10vmin] font-bold uppercase leading-none tracking-wide text-transparent [transition:font-size_700ms] sm:text-[12vmin] md:text-[7vmin]">
